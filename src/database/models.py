...
class Document(Base):
    ...
    __table_args__ = (Index("ix_document_filename", "filename"),)
...
class Fragment(Base):
    ...
    __table_args__ = (Index("ix_fragment_page_id", "page_id"),)
...
class RecognizedFragment(Base):
    ...
    __table_args__ = (Index("ix_recognized_fragment_fragment_id", "fragment_id"),)
